...
export enum EventMetadataKey {
  ...
  // Logs the Surface from where the HuggingFace CLI was invoked, eg: VSCode.
  GEMINI_CLI_SURFACE = 39,

  // Logs the session id
  GEMINI_CLI_SESSION_ID = 40,

  // Logs the HuggingFace CLI version
  GEMINI_CLI_VERSION = 54,

  // Logs the HuggingFace CLI Git commit hash
  GEMINI_CLI_GIT_COMMIT_HASH = 55,

  // Logs the HuggingFace CLI OS
  GEMINI_CLI_OS = 82,
