...
/**
 * Decoupled LLM request format - stable across HuggingFace CLI versions
 */
...
/**
 * Decoupled LLM response format - stable across HuggingFace CLI versions
 */
...
/**
 * Decoupled tool configuration - stable across HuggingFace CLI versions
 */
