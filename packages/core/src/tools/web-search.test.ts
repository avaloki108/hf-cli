        ...
        candidates: [
          {
            content: {
              role: 'model',
              parts: [{ text: 'こんにちは! HuggingFace CLI✨️' }],
            },
            groundingMetadata: {
              groundingChunks: [
                {
                ...
                {
                  web: {
                    title: 'HuggingFace CLI: your open-source AI agent',
              ...
              groundingSupports: [
                ...
                {
                  segment: {
                    // Byte range of "HuggingFace CLI✨️" (utf-8 encoded)
                    startIndex: 17,
                    endIndex: 33,
                  },
...
[3] HuggingFace CLI: your open-source AI agent (https://blog.google/technology/developers/introducing-gemini-cli-open-source-ai-agent/)`;
