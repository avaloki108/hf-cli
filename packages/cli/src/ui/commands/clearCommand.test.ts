...
vi.mock('@huggingface/hf-cli-core', async () => {
  const actual = await vi.importActual('@huggingface/hf-cli-core');
  return {
    ...actual,
    uiTelemetryService: {
...
import type { GeminiClient } from '@huggingface/hf-cli-core';
import { uiTelemetryService } from '@huggingface/hf-cli-core';
