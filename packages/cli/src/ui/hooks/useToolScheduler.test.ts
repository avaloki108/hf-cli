...
import { createMockMessageBus } from '@huggingface/hf-cli-core/src/test-utils/mock-message-bus.js';
import { ToolCallStatus } from '../types.js';

// Mocks
vi.mock('@huggingface/hf-cli-core', async () => {
  const actual = await vi.importActual<any>('@huggingface/hf-cli-core');
