...
import type { OutputFormat } from '@huggingface/hf-cli-core';
...
import type { ExtensionEvents } from '@huggingface/hf-cli-core/src/utils/extensionLoader.js';
...
export async function parseArguments(settings: Settings): Promise<CliArgs> {
  ...
  const yargsInstance = yargs(rawArgv)
    ...
    .scriptName('hf')
    .usage(
      'Usage: hf [options] [command]\n\nHugging Face CLI - Launch an interactive CLI, use -p/--prompt for non-interactive mode',
    )
