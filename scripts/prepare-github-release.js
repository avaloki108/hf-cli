...
// Update @huggingface/hf-cli
updatePackageJson('packages/cli/package.json', (pkg) => {
  pkg.name = '@huggingface/hf-cli';
  pkg.files = ['bundle/'];
  pkg.bin = {
...
// Update @huggingface/hf-cli-a2a-server
updatePackageJson('packages/a2a-server/package.json', (pkg) => {
  pkg.name = '@huggingface/hf-cli-a2a-server';
});

// Update @huggingface/hf-cli-core
updatePackageJson('packages/core/package.json', (pkg) => {
  pkg.name = '@huggingface/hf-cli-core';
});
