...
if (!image.length) {
  console.warn(
    'No default image tag specified in hf-cli/packages/cli/package.json',
  );
}
...
chmodSync(
  join(cliPackageDir, 'dist', `google-hf-cli-${packageVersion}.tgz`),
  0o755,
);
chmodSync(
  join(corePackageDir, 'dist', `google-hf-cli-core-${packageVersion}.tgz`),
  0o755,
);
