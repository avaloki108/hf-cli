...
2.  **Run HuggingFace CLI with dev tracing:**

    In a separate terminal, run your HuggingFace CLI command with the
...
```typescript
import { runInDevTraceSpan } from '@google/hf-cli-core';
