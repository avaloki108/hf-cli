# HuggingFace CLI: License, Terms of Service, and Privacy Notices

HuggingFace CLI is an open-source tool that lets you interact with Google's
powerful AI services directly from your command-line interface. The HuggingFace
CLI software is licensed under the
[Apache 2.0 license](https://github.com/google-gemini/hf-cli/blob/main/LICENSE).
When you use HuggingFace CLI to access or use Google’s services, the Terms of
Service and Privacy Notices applicable to those services apply to such access
and use.

Your HuggingFace CLI Usage Statistics are handled in accordance with Google's
Privacy Policy.

**Note:** See [quotas and pricing](/docs/quota-and-pricing.md) for the quota and
pricing details that apply to your usage of the HuggingFace CLI.

## Supported authentication methods

Your authentication method refers to the method you use to log into and access
Google’s services with HuggingFace CLI. Supported authentication methods
include:
...
- Terms of Service: Your use of the HuggingFace CLI is governed by the
...
You may opt-out from sending HuggingFace CLI Usage Statistics to Google by
following the instructions available here:
[Usage Statistics Configuration](https://github.com/google-gemini/hf-cli/blob/main/docs/get-started/configuration.md#usage-statistics).
