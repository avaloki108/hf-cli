# HuggingFace CLI Changelog

Wondering what's new in HuggingFace CLI? This document provides key highlights
and notable changes to HuggingFace CLI.

## v0.15.0 - HuggingFace CLI weekly update - 2025-11-03

- **🎉 Seamless scrollable UI & mouse support:** We’ve given HuggingFace CLI a
...
- **Todo planning:** Complex questions now get broken down into todo lists that
  ...
  [pr](https://github.com/google-gemini/hf-cli/pull/12905) by
...
- **Disable GitHub extensions:** Users can now prevent the installation and
  ...
  ([pr](https://github.com/google-gemini/hf-cli/pull/12838) by
...
- **Extensions restart:** Users can now explicitly restart extensions using the
  ...
  ([pr](https://github.com/google-gemini/hf-cli/pull/12739) by
  [@jakemac53](https://github.com/jakemac53)).
- **Better Angular support:** Angular workflows should now be more seamless
  ([pr](https://github.com/google-gemini/hf-cli/pull/10252) by
  [@MarkTechson](https://github.com/MarkTechson)).
- **Validate command:** Users can now check that local extensions are formatted
  correctly. ([pr](https://github.com/google-gemini/hf-cli/pull/12186) by
  [@kevinjwang1](https://github.com/kevinjwang1)).

## v0.12.0 - HuggingFace CLI weekly update - 2025-10-27

![Codebase investigator subagent in HuggingFace CLI.](https://i.imgur.com/4J1njsx.png)
...
- **🎉 New partner extensions:**
  ...
  - **Data Commons extension:** Query public datasets or ground responses on
    ...
    `gemini extensions install https://github.com/hf-cli-extensions/datacommons`

- **Model selection:** Choose the Gemini model for your session with `/model`.
  ([pic](https://imgur.com/a/ABFcWWw),
  [pr](https://github.com/google-gemini/hf-cli/pull/8940) by
  [@abhipatel12](https://github.com/abhipatel12)).
- **Model routing:** HuggingFace CLI will now intelligently pick the best model
  for the task. Simple queries will be sent to Flash while complex analytical or
  ...
  ([pr](https://github.com/google-gemini/hf-cli/pull/9262) by
  [@abhipatel12](https://github.com/abhipatel12)).
  - Discussion:
    [https://github.com/google-gemini/hf-cli/discussions/12375](https://github.com/google-gemini/hf-cli/discussions/12375)
- **Codebase investigator subagent:** We now have a new built-in subagent that
  ...
  overall performance. ([pr](https://github.com/google-gemini/hf-cli/pull/9988)
  by [@abhipatel12](https://github.com/abhipatel12),
  [pr](https://github.com/google-gemini/hf-cli/pull/10282) by
  ...
  - Enable, disable, or limit turns in `/settings`, plus advanced configs in
    ...
    [pr](https://github.com/google-gemini/hf-cli/pull/10844) by
    [@silviojr](https://github.com/silviojr)).
- **Explore extensions with `/extension`:** Users can now open the extensions
  ...
  explore command. ([pr](https://github.com/google-gemini/hf-cli/pull/11846) by
...
- **Configurable compression:** Users can modify the compression threshold in
  ...
  ([pr](https://github.com/google-gemini/hf-cli/pull/12317) by
...
- **API key authentication:** Users can now securely enter and store their
  ...
  ([pr](https://github.com/google-gemini/hf-cli/pull/11760) by
  [@galz10](https://github.com/galz10)).
- **Sequential approval:** Users can now approve multiple tool calls
  sequentially during execution.
  ([pr](https://github.com/google-gemini/hf-cli/pull/11593) by
  [@joshualitt](https://github.com/joshualitt)).

## v0.11.0 - HuggingFace CLI weekly update - 2025-10-20

![HuggingFace CLI and Jules](https://storage.googleapis.com/gweb-developer-goog-blog-assets/images/Jules_Extension_-_Blog_Header_O346JNt.original.png)

- 🎉 **HuggingFace CLI Jules Extension:** Use HuggingFace CLI to orchestrate
  Jules. Spawn remote workers, delegate tedious tasks, or check in on running
  jobs!
  - Install:
    `gemini extensions install https://github.com/hf-cli-extensions/jules`
  - Announcement:
    [https://developers.googleblog.com/en/introducing-the-jules-extension-for-hf-cli/](https://developers.googleblog.com/en/introducing-the-jules-extension-for-hf-cli/)
- **Stream JSON output:** Stream real-time JSONL events with
  ...
  [pr](https://github.com/google-gemini/hf-cli/pull/10883) by
  [@anj-s](https://github.com/anj-s))
- **Markdown toggle:** Users can now switch between rendered and raw markdown
  ...
  [pr](https://github.com/google-gemini/hf-cli/pull/10383) by
...
- **Queued message editing:** Users can now quickly edit queued messages by
  ...
  [pr](https://github.com/google-gemini/hf-cli/pull/10392) by
...
- **JSON web fetch**: Non-HTML content like JSON APIs or raw source code are now
  ...
  [pr](https://github.com/google-gemini/hf-cli/pull/11284) by
  [@abhipatel12](https://github.com/abhipatel12))
- **Non-interactive MCP commands:** Users can now run MCP slash commands in
  non-interactive mode `gemini "/some-mcp-prompt"`.
  ([pr](https://github.com/google-gemini/hf-cli/pull/10194) by
  [@capachino](https://github.com/capachino))
- **Removal of deprecated flags:** We’ve finally removed a number of deprecated
  flags to cleanup HuggingFace CLI’s invocation profile:
  - `--all-files` / `-a` in favor of `@` from within HuggingFace CLI.
    ([pr](https://github.com/google-gemini/hf-cli/pull/11228) by
    [@allenhutchison](https://github.com/allenhutchison))
  - `--telemetry-*` flags in favor of
    [environment variables](https://github.com/google-gemini/hf-cli/pull/11318)
    ([pr](https://github.com/google-gemini/hf-cli/pull/11318) by
    [@allenhutchison](https://github.com/allenhutchison))

## v0.10.0 - HuggingFace CLI weekly update - 2025-10-13

- **Polish:** The team has been heads down bug fixing and investing heavily into
  polishing existing flows, tools, and interactions.
- **Interactive Shell Tool calling:** HuggingFace CLI can now also execute
  interactive tools if needed
  ([pr](https://github.com/google-gemini/hf-cli/pull/11225) by
  [@galz10](https://github.com/galz10)).
- **Alt+Key support:** Enables broader support for Alt+Key keyboard shortcuts
  across different terminals.
  ([pr](https://github.com/google-gemini/hf-cli/pull/10767) by
  [@srivatsj](https://github.com/srivatsj)).
- **Telemetry Diff stats:** Track line changes made by the model and user during
  file operations via OTEL.
  ([pr](https://github.com/google-gemini/hf-cli/pull/10819) by
  [@jerop](https://github.com/jerop)).

## v0.9.0 - HuggingFace CLI weekly update - 2025-10-06

- 🎉 **Interactive Shell:** Run interactive commands like `vim`, `rebase -i`, or
  even `hf` 😎 directly in HuggingFace CLI:
  - Blog:
    [https://developers.googleblog.com/en/say-hello-to-a-new-level-of-interactivity-in-hf-cli/](https://developers.googleblog.com/en/say-hello-to-a-new-level-of-interactivity-in-hf-cli/)
- **Install pre-release extensions:** Install the latest `--pre-release`
  ...
  marked as "latest". ([pr](https://github.com/google-gemini/hf-cli/pull/10752)
  by [@jakemac53](https://github.com/jakemac53))
- **Simplified extension creation:** Create a new, empty extension. Templates
  are no longer required.
  ([pr](https://github.com/google-gemini/hf-cli/pull/10629) by
...
- **OpenTelemetry GenAI metrics:** Aligns telemetry with industry-standard
  ...
  [pr](https://github.com/google-gemini/hf-cli/pull/10343) by
  [@jerop](https://github.com/jerop))
- **List memory files:** Quickly find the location of your long-term memory
  files with `/memory list`.
  ([pr](https://github.com/google-gemini/hf-cli/pull/10108) by
  [@sgnagnarella](https://github.com/sgnagnarella))

## v0.8.0 - HuggingFace CLI weekly update - 2025-09-29

- 🎉 **Announcing HuggingFace CLI Extensions** 🎉
  - Completely customize your HuggingFace CLI experience to fit your workflow.
  - Build and share your own HuggingFace CLI extensions with the world.
  - Launching with a growing catalog of community, partner, and Google-built
    extensions.
    - Check extensions from
      [key launch partners](https://github.com/google-gemini/hf-cli/discussions/10718).
  - Easy install:
  ...
  - Everything you need to know:
    [Now open for building: Introducing HuggingFace CLI extensions](https://blog.google/technology/developers/hf-cli-extensions/).
- 🎉 **Our New Home Page & Better Documentation** 🎉
  ...
  - ‼️*NEW documentation:*
    ...
    [suggestions](https://github.com/google-gemini/hf-cli/discussions/8722)?)
  - _Extensions:_
...
- **Non-Interactive Allowed Tools:** `--allowed-tools` will now also work in
  non-interactive mode. ([pr](https://github.com/google-gemini/hf-cli/pull/9114)
...
- **Terminal Title Status:** See the CLI's real-time status and thoughts
  ...
  ([pr](https://github.com/google-gemini/hf-cli/pull/4386) by
...
## v0.7.0 - HuggingFace CLI weekly update - 2025-09-22

- 🎉**Build your own HuggingFace CLI IDE plugin:** We've published a spec for
  creating IDE plugins to enable rich context-aware experiences and native
  in-editor diffing in your IDE of choice.
  ([pr](https://github.com/google-gemini/hf-cli/pull/8479) by
...
- 🎉 **HuggingFace CLI extensions**
  - **Flutter:** An early version to help you create, build, test, and run
    Flutter apps with HuggingFace CLI
    ([extension](https://github.com/hf-cli-extensions/flutter))
  - **nanobanana:** Integrate nanobanana into HuggingFace CLI
    ([extension](https://github.com/hf-cli-extensions/nanobanana))
- **Telemetry config via environment:** Manage telemetry settings using
  environment variables for a more flexible setup.
  ([docs](https://github.com/google-gemini/hf-cli/blob/main/docs/cli/telemetry.md#configuration),
  [pr](https://github.com/google-gemini/hf-cli/pull/9113) by
  [@jerop](https://github.com/jerop))
- **​​Experimental todos:** Track and display progress on complex tasks with a
  ...
  `"useWriteTodos": true`
  ([pr](https://github.com/google-gemini/hf-cli/pull/8761) by
  [@anj-s](https://github.com/anj-s))
- **Share chat support for tools:** Using `/chat share` will now also render
  ...
  ([pr](https://github.com/google-gemini/hf-cli/pull/8693) by
  [@rramkumar1](https://github.com/rramkumar1))
- **Citations:** Now enabled for all users
  ([pr](https://github.com/google-gemini/hf-cli/pull/8570) by
  [@scidomino](https://github.com/scidomino))
- **Custom commands in Headless Mode:** Run custom slash commands directly from
  ...
  ([pr](https://github.com/google-gemini/hf-cli/pull/8305) by
  [@capachino](https://github.com/capachino))
- **Small features, polish, reliability & bug fixes:** A large amount of
  changes, smaller features, UI updates, reliability and bug fixes + general
  polish made it in this week!

## v0.6.0 - HuggingFace CLI weekly update - 2025-09-15
...
- 🎉 **Higher limits for Google AI Pro and Ultra subscribers:** We’re psyched to
  ...
  significantly higher 2.5 quota limits for HuggingFace CLI!
  - **Announcement:**
    [https://blog.google/technology/developers/hf-cli-code-assist-higher-limits/](https://blog.google/technology/developers/hf-cli-code-assist-higher-limits/)
- 🎉**HuggingFace CLI Databases and BigQuery Extensions:** Connect HuggingFace
  CLI to all of your cloud data with HuggingFace CLI.
  - Announcement and how to get started with each of the below extensions:
    [https://cloud.google.com/blog/products/databases/hf-cli-extensions-for-google-data-cloud?e=48754805](https://cloud.google.com/blog/products/databases/hf-cli-extensions-for-google-data-cloud?e=48754805)
  - **AlloyDB:** Interact, manage and observe AlloyDB for PostgreSQL databases
    ([manage](https://github.com/hf-cli-extensions/alloydb#configuration),
    [observe](https://github.com/hf-cli-extensions/alloydb-observability#configuration))
  - **BigQuery:** Connect and query your BigQuery datasets or utilize a
    sub-agent for contextual insights
    ([query](https://github.com/hf-cli-extensions/bigquery-data-analytics#configuration),
    [sub-agent](https://github.com/hf-cli-extensions/bigquery-conversational-analytics))
  - **Cloud SQL:** Interact, manage and observe Cloud SQL for PostgreSQL
    ([manage](https://github.com/hf-cli-extensions/cloud-sql-postgresql#configuration),[ observe](https://github.com/hf-cli-extensions/cloud-sql-postgresql-observability#configuration)),
    Cloud SQL for MySQL
    ([manage](https://github.com/hf-cli-extensions/cloud-sql-mysql#configuration),[ observe](https://github.com/hf-cli-extensions/cloud-sql-mysql-observability#configuration))
    and Cloud SQL for SQL Server
    ([manage](https://github.com/hf-cli-extensions/cloud-sql-sqlserver#configuration),[ observe](https://github.com/hf-cli-extensions/cloud-sql-sqlserver-observability#configuration))
    databases.
  - **Dataplex:** Discover, manage, and govern data and AI artifacts
    ([extension](https://github.com/hf-cli-extensions/dataplex#configuration))
  - **Firestore:** Interact with Firestore databases, collections and documents
    ([extension](https://github.com/hf-cli-extensions/firestore-native#configuration))
  - **Looker:** Query data, run Looks and create dashboards
    ([extension](https://github.com/hf-cli-extensions/looker#configuration))
  - **MySQL:** Interact with MySQL databases
    ([extension](https://github.com/hf-cli-extensions/mysql#configuration))
  - **Postgres:** Interact with PostgreSQL databases
    ([extension](https://github.com/hf-cli-extensions/postgres#configuration))
  - **Spanner:** Interact with Spanner databases
    ([extension](https://github.com/hf-cli-extensions/spanner#configuration))
  - **SQL Server:** Interact with SQL Server databases
    ([extension](https://github.com/hf-cli-extensions/sql-server#configuration))
  - **MCP Toolbox:** Configure and load custom tools for more than 30+ data
    sources
    ([extension](https://github.com/hf-cli-extensions/mcp-toolbox#configuration))
- **JSON output mode:** Have HuggingFace CLI output JSON with
  `--output-format json` when invoked headlessly for easy parsing and
  post-processing. Includes response, stats and errors.
  ([pr](https://github.com/google-gemini/hf-cli/pull/8119) by
  [@jerop](https://github.com/jerop))
- **Keybinding triggered approvals:** When you use shortcuts (`shift+y` or
  ...
  will now approve. ([pr](https://github.com/google-gemini/hf-cli/pull/6665) by
...
- **Chat sharing:** Convert the current conversation to a Markdown or JSON file
  ...
  ([pr](https://github.com/google-gemini/hf-cli/pull/8139) by
  [@rramkumar1](https://github.com/rramkumar1))
- **Prompt search:** Search your prompt history using `ctrl+r`.
  ([pr](https://github.com/google-gemini/hf-cli/pull/5539) by
...
- **Input undo/redo:** Recover accidentally deleted text in the input prompt
  ...
  ([pr](https://github.com/google-gemini/hf-cli/pull/4625) by
...
- **Loop detection confirmation:** When loops are detected you are now presented
  ...
  ([pr](https://github.com/google-gemini/hf-cli/pull/8231) by
...
- **Direct to Google Cloud Telemetry:** Directly send telemetry to Google Cloud
  ...
  ([pr](https://github.com/google-gemini/hf-cli/pull/8541) by
  [@jerop](https://github.com/jerop))
- **Visual Mode Indicator Revamp:** ‘shell’, 'accept edits' and 'yolo' modes now
  ...
  [pr](https://github.com/google-gemini/hf-cli/pull/8200) by
  [@miguelsolorio](https://github.com/miguelsolorio))
- **Small features, polish, reliability & bug fixes:** A large amount of
  changes, smaller features, UI updates, reliability and bug fixes + general
  polish made it in this week!

## v0.5.0 - HuggingFace CLI weekly update - 2025-09-08

- 🎉**FastMCP + HuggingFace CLI**🎉: Quickly install and manage your HuggingFace
  CLI MCP servers with FastMCP ([video](https://imgur.com/a/m8QdCPh),
  [pr](https://github.com/jlowin/fastmcp/pull/1709) by
  [@jackwotherspoon](https://github.com/jackwotherspoon)**)**
  - Getting started:
    [https://gofastmcp.com/integrations/hf-cli](https://gofastmcp.com/integrations/hf-cli)
- **Positional Prompt for Non-Interactive:** Seamlessly invoke HuggingFace CLI
  headlessly via `gemini "Hello"`. Synonymous with passing `-p`.
  ([gif](https://imgur.com/a/hcBznpB),
  [pr](https://github.com/google-gemini/hf-cli/pull/7668) by
  [@allenhutchison](https://github.com/allenhutchison))
- **Experimental Tool output truncation:** Enable truncating shell tool outputs
  and saving full output to a file by setting
  `"enableToolOutputTruncation": true `([pr](https://github.com/google-gemini/hf-cli/pull/8039)
  by [@SandyTao520](https://github.com/SandyTao520))
- **Edit Tool improvements:** HuggingFace CLI’s ability to edit files should now
  be far more capable. ([pr](https://github.com/google-gemini/hf-cli/pull/7679)
...
- **Custom witty messages:** The feature you’ve all been waiting for…
  ...
  ([pr](https://github.com/google-gemini/hf-cli/pull/7641) by
  [@JayadityaGit](https://github.com/JayadityaGit))
- **Nested .gitignore File Handling:** Nested `.gitignore` files are now
  respected. ([pr](https://github.com/google-gemini/hf-cli/pull/7645) by
...
- **Enforced authentication:** System administrators can now mandate a specific
  ...
  ([pr](https://github.com/google-gemini/hf-cli/pull/6564) by
  [@chrstnb](https://github.com/chrstnb))
- **A2A development-tool extension:** An RFC for an Agent2Agent
  ...
  use cases.
  ([feedback](https://github.com/google-gemini/hf-cli/discussions/7822),
  [pr](https://github.com/google-gemini/hf-cli/pull/7817) by
  [@skeshive](https://github.com/skeshive))
- **Hands on Codelab:
  **[https://codelabs.developers.google.com/hf-cli-hands-on](https://codelabs.developers.google.com/hf-cli-hands-on)
- **Small features, polish, reliability & bug fixes:** A large amount of
  changes, smaller features, UI updates, reliability and bug fixes + general
  polish made it in this week!

## v0.4.0 - HuggingFace CLI weekly update - 2025-09-01

- 🎉**HuggingFace CLI CloudRun and Security Integrations**🎉: Automate app
  ...
  - Announcement and how to get started:
    [https://cloud.google.com/blog/products/ai-machine-learning/automate-app-deployment-and-security-analysis-with-new-hf-cli-extensions](https://cloud.google.com/blog/products/ai-machine-learning/automate-app-deployment-and-security-analysis-with-new-hf-cli-extensions)
- **Experimental**
  - **Edit Tool:** Give our new edit tool a try by setting
    `"useSmartEdit": true` in `settings.json`!
    ([feedback](https://github.com/google-gemini/hf-cli/discussions/7758),
    [pr](https://github.com/google-gemini/hf-cli/pull/6823) by
    [@silviojr](https://github.com/silviojr))
  - **Model talking to itself fix:** We’ve removed a model workaround that would
    encourage HuggingFace CLI to continue conversations on your behalf. This may
    be disruptive and can be disabled via `"skipNextSpeakerCheck": false` in
    your `settings.json`
    ([feedback](https://github.com/google-gemini/hf-cli/discussions/6666),
    [pr](https://github.com/google-gemini/hf-cli/pull/7614) by
    [@SandyTao520](https://github.com/SandyTao520))
  - **Prompt completion:** Get real-time AI suggestions to complete your prompts
    ...
    [pr](https://github.com/google-gemini/hf-cli/pull/4691) by
    [@3ks](https://github.com/3ks))
- **Footer visibility configuration:** Customize the CLI's footer look and feel
  in `settings.json` ([pr](https://github.com/google-gemini/hf-cli/pull/7419) by
  [@miguelsolorio](https://github.com/miguelsolorio))
...
- **Citations:** For enterprise Code Assist licenses users will now see
  ...
  `"showCitations": true`
  ([pr](https://github.com/google-gemini/hf-cli/pull/7350) by
  [@scidomino](https://github.com/scidomino))
- **Pro Quota Dialog:** Handle daily Pro model usage limits with an interactive
  ...
  ([pr](https://github.com/google-gemini/hf-cli/pull/7094) by
  [@JayadityaGit](https://github.com/JayadityaGit))
...
- **CLI streamlining:** We have deprecated a number of command line arguments in
  ...
  ([pr](https://github.com/google-gemini/hf-cli/pull/7360) by
  [@allenhutchison](https://github.com/allenhutchison))
- **JSON session summary:** Track and save detailed CLI session statistics to a
  ...
  ([pr](https://github.com/google-gemini/hf-cli/pull/7347) by
...
- **Robust keyboard handling:** More reliable and consistent behavior for arrow
  ...
  terminals. ([pr](https://github.com/google-gemini/hf-cli/pull/7118) by
...
- **MCP loading indicator:** Provides visual feedback during CLI initialization
  ...
  ([pr](https://github.com/google-gemini/hf-cli/pull/6923) by
