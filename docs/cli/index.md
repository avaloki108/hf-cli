...
Within HuggingFace CLI, `packages/cli` is the frontend for users to send and
receive prompts with the Gemini AI model and its associated tools. For a general
overview of HuggingFace CLI, see the [main documentation page](../index.md).
...
- **[Headless mode](./headless.md):** Use HuggingFace CLI programmatically for
...
- **[Context files (HF.md)](./gemini-md.md):** Provide persistent, hierarchical
  context to the model.

## Non-interactive mode

HuggingFace CLI can be run in a non-interactive mode, which is useful for
scripting and automation. In this mode, you pipe input to the CLI, it executes
the command, and then it exits.

The following example pipes a command to HuggingFace CLI from your terminal:
