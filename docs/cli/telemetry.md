...
Learn how to enable and setup OpenTelemetry for HuggingFace CLI.
...
observability framework — HuggingFace CLI's observability system provides:
...
credentials that you use to log in to the HuggingFace CLI. This is useful in
...
1. Enable telemetry in your `.gemini/settings.json`:
   ...
   ```
2. Run HuggingFace CLI and send prompts.
...
3. Run HuggingFace CLI and send prompts.
...
for HuggingFace CLI, grouped by category.
