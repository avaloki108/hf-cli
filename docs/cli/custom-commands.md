...
prompts as personal shortcuts within HuggingFace CLI. You can create commands
...
HuggingFace CLI discovers commands from two locations, loaded in a specific
order:
...
When a custom command attempts to execute a shell command, HuggingFace CLI will
...
HuggingFace CLI will then execute the multi-line prompt defined in your TOML
file.
