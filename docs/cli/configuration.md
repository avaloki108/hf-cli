...
HuggingFace CLI uses `settings.json` files for persistent configuration. There
are three locations for these files:
...
- **Project settings file:**
  ...
  - **Scope:** Applies only when running HuggingFace CLI from that specific
    project. Project settings override user settings.
- **System settings file:**
  ...
  - **Scope:** Applies to all HuggingFace CLI sessions on the system, for all
    users. System settings override user and project settings. May be useful for
    system administrators at enterprises to have controls over users'
    HuggingFace CLI setups.
...
- **`theme`** (string):
  - **Description:** Sets the visual [theme](./themes.md) for HuggingFace CLI.
  - **Default:** `"Default"`
...
- **`telemetry`** (object)
  - **Description:** Configures logging and metrics collection for HuggingFace
    CLI. For more information, see [Telemetry](./telemetry.md).
  - **Default:**
