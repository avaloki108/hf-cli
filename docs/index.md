# Welcome to HuggingFace CLI documentation

This documentation provides a comprehensive guide to installing, using, and
developing HuggingFace CLI, a tool that lets you interact with Gemini models
through a command-line interface.

## HuggingFace CLI overview

HuggingFace CLI brings the capabilities of Gemini models to your terminal in an
interactive Read-Eval-Print Loop (REPL) environment. HuggingFace CLI consists of
a client-side application (`packages/cli`) that communicates with a local server
(`packages/core`), which in turn manages requests to the Gemini API and its AI
models. HuggingFace CLI also contains a variety of tools for tasks such as
...
- **[Architecture overview](./architecture.md):** Understand the high-level
  design of HuggingFace CLI, including its components and how they interact.
...
- **[HuggingFace CLI quickstart](./get-started/index.md):** Let's get started
  with HuggingFace CLI.
- **[Gemini 3 Pro on HuggingFace CLI](./get-started/gemini-3.md):** Learn how to
...
- **[Configuration](./get-started/configuration.md):** Learn how to configure
  the CLI.
- **[Installation](./get-started/installation.md):** Install and run HuggingFace
  CLI.
- **[Examples](./get-started/examples.md):** Example usage of HuggingFace CLI.

### CLI

- **[Introduction: HuggingFace CLI](./cli/index.md):** Overview of the
...
- **[Enterprise](./cli/enterprise.md):** HuggingFace CLI for enterprise.
- **[Headless mode](./cli/headless.md):** Use HuggingFace CLI programmatically
...
- **[Themes](./cli/themes.md):** Themes for HuggingFace CLI.
...
- **[Tutorials](./cli/tutorials.md):** Tutorials for HuggingFace CLI.
- **[Uninstall](./cli/uninstall.md):** Methods for uninstalling the HuggingFace
  CLI.

### Core

- **[Introduction: HuggingFace CLI core](./core/index.md):** Information about
  Gemini CLI core.
...
- **[Introduction: HuggingFace CLI tools](./tools/index.md):** Information about
  HuggingFace CLI's tools.
...
- **[MCP servers](./tools/mcp-server.md):** Using MCP servers with HuggingFace
  CLI.
...
- **[Hooks](./hooks/index.md):** Intercept and customize HuggingFace CLI
...
- **[Terms of service and privacy notice](./tos-privacy.md):** Information on
  the terms of service and privacy notices applicable to your use of HuggingFace
  CLI.

We hope this documentation helps you make the most of HuggingFace CLI!
