...
problems encountered while using HuggingFace CLI.
...
your total token usage using the `/stats` command in HuggingFace CLI.

## Installation and updates

### How do I update HuggingFace CLI to the latest version?

If you installed it globally via `npm`, update it using the command
`npm install -g @huggingface/hf-cli@latest`. If you compiled it from source,
...
- **Use a `.env` file:** Create a `.env` file in your project's `.gemini`
  directory (`.gemini/.env`) and store your keys there. HuggingFace CLI will
...
### Where are the HuggingFace CLI configuration and settings files stored?

The HuggingFace CLI configuration is stored in two `settings.json` files:

1.  In your home directory: `~/.gemini/settings.json`.
2.  In your project's root directory: `./.gemini/settings.json`.

Refer to [HuggingFace CLI Configuration](./get-started/configuration.md) for
more details.
...
limits to Gemini Code Assist and HuggingFace CLI. These are shared across
HuggingFace CLI and agent mode in the IDE. You can confirm you have higher
limits by checking if you are still subscribed to Google AI Pro or Ultra in your
[subscription settings](https://one.google.com).

### What is the privacy policy for using Gemini Code Assist or HuggingFace CLI if I've subscribed to Google AI Pro or Ultra?
...
across both Gemini 2.5 Pro and Flash. They are shared quota across HuggingFace
CLI and agent mode in Gemini Code Assist IDE extensions. You can learn more
about quota limits for HuggingFace CLI, Gemini Code Assist and agent mode in
Gemini Code Assist at
[Quotas and limits](https://developers.google.com/gemini-code-assist/resources/quotas).

### If I upgrade to higher limits for HuggingFace CLI and Gemini Code Assist by purchasing a Google AI Pro or Ultra subscription, will Gemini start using my data to improve its machine learning models?
...
Search the
[HuggingFace CLI Q&A discussions on GitHub](https://github.com/google-gemini/hf-cli/discussions/categories/q-a)
or
[start a new discussion on GitHub](https://github.com/google-gemini/hf-cli/discussions/new?category=q-a)
