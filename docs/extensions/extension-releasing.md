...
HuggingFace CLI extensions can be distributed through
...
To ensure HuggingFace CLI can automatically find the correct release asset for
...
HuggingFace CLI extension for multiple platforms:
